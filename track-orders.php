      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            <li class="myaccount"><a href="#"><span>My Account</a></span></li>
            <li class="wishlist"><a href="#"><span>Wishlist</a></span></li>
            <li class="header_cart hi"><a href="#"><span>My Cart</a></span></li>
            <li class="check"><a href="#"><span>Checkout</a></span></li>
            <li class="login"><a href="#"><span>Login</a></span></li>
          </ul>
        </div>
        <!-- /.cnt-account -->
    ...
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-4 no-padding">
        <div class="clearfix payment-methods">
          <ul>
            <li><img src="<?php echo $img; ?>payments/1.png" alt=""></li>
            <li><img src="<?php echo $img; ?>payments/2.png" alt=""></li>
            <li><img src="<?php echo $img; ?>payments/3.png" alt=""></li>
            <li><img src="<?php echo $img; ?>payments/4.png" alt=""></li>
            <li><img src="<?php echo $img; ?>payments/5.png" alt=""></li>
          </ul>
        </div>
        <!-- /.payment-methods -->
      </div>
