      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            <li class="myaccount"><a href="sign-in.php"><span>My Account</span></a></li>
            ...
            <ul class="dropdown-menu">
              <li>
                <div class="cart-item product-summary">
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> <a href="detail.php"><img src="<?php echo $img; ?>products/p4.jpg" alt=""></a> </div>
                    </div>
                    <div class="col-xs-7">
                      <h3 class="name"><a href="index8a95.php?page-detail">Simple Product</a></h3>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <a href="category.php"  data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Electronics <span class="menu-label hot-menu hidden-xs">hot</span> </a>
                  <ul class="dropdown-menu container cust_menu" style="background-image:url('<?php echo $img; ?>banners/iphone-11.png')">
                    ...
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                          ...
                          <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="<?php echo $img; ?>banners/iphone-11.png"></a> </div> -->
                        </div>
                        <!-- /.row -->
                      </div>
                      <!-- /.yamm-content --> </li>
                ...
                <li class="dropdown hidden-sm"> <a href="category.php">Categories <span class="menu-label new-menu hidden-xs">new</span> </a> </li>
                <li class="dropdown hidden-sm"> <a href="category.php">What's New</a> </li>
